...
const PinDetail = () => {
  ...
  if (!pin) {
    return (
      <div className="d-flex">
        <Sidebar />
        <div className="flex-grow-1 p-4">Rasm topilmadi</div>
      </div>
    );
  }
  ...
  return (
    <div className="d-flex">
        ...
        <div className="row g-4" style={{ maxWidth: "900px" }}>
          ...
          <div className="col-md-6">
            <div className="d-flex gap-2 mb-3">
              ...
              >
                <i className="bi bi-download me-1"></i> Yuklab olish
              </a>
              ...
              >
                <i className="bi bi-bookmark-fill me-1"></i> Saqlash
              </button>
            </div>
            ...
            <div className="d-flex gap-3 text-secondary small mb-3">
              <span>
                <i className="bi bi-eye me-1"></i> {pin.views} ko'rish
              </span>
              <span>
                <i className="bi bi-heart me-1"></i> {likesCount} layk
              </span>
            </div>
      ...
      {showSaveModal && (
        <Modal title="Boardga saqlash" onClose={() => setShowSaveModal(false)}>
          {myBoards.length === 0 ? (
            <p className="text-secondary small">Sizda hali boardlar yo'q</p>
          ) : (
